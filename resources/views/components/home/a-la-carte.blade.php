...
<x-layout.section>
    <x-layout.container>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
            <x-step-segment step="1" title="Choose a Base Package">
                <x-slot name="left">
                    <p>Begin your photobooth journey by exploring our comprehensive base package. Discover all the
                        exciting features and
                        inclusions that form the foundation of your unforgettable event.</p>
                </x-slot>
                {{-- <x-slot name="right">
                    <a href="">
                        <div
                            class="relative w-52 h-80 hover:scale-105 transition ease-in-out delay-[50ms] duration-300">
                            ...
                            <video class="absolute object-cover h-[125px] translate-x-[53px] translate-y-[80px]"
                                autoplay loop muted>
            ...
            <x-step-segment step="2" title="Customize Your Experience">
                <x-slot name="left">
                    <p>
                        Take your event to the next level by customizing your photobooth experience with our wide range
                        of
                        add-ons. Whether it's
                        extra hours, themed props, or unique backdrops, our add-ons allow you to personalize your
                        photobooth
                        rental to suit your
            ...
            <x-step-segment step="3" title="Book Your Date">
                <x-slot name="left">
                    <p>
                        Ready to make your event unforgettable? It's time to book your date with us! Get in touch with
                        our
                        friendly
                        team to
